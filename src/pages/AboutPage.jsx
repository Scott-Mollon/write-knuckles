    ...
    <div className="about-page bg-ink text-cream">
      ...
      <main className="about-page__main">
        <header className="about-page__hero">
          ...
          <h1 className="about-page__title">Knock out your story.</h1>
        ...
        <section className="about-page__section">
          ...
          <div className="about-page__prose">
            ...
            <p>
              ...
              organizing and writing a Tale is another. Ideas scattered across handwritten notes, scenes in
              separate files, big long Google Docs, structure in a spreadsheet - the fun drained out before
        ...
        <section className="about-page__section">
          ...
          <div className="about-page__prose">
            ...
            <p>
              ...
              to explore while you figure out that final chapter twist.
            </p>
          </div>
        </section>
        ...
        <section className="about-page__section">
          ...
          <div className="about-page__prose">
            ...
            <p>
              <strong className="text-bronze">Read and Publish</strong> with Bronze Knuckles Magazine - pulp fiction,
        ...
        <section className="about-page__section about-page__section--cta">
          <h2 className="about-page__section-title">Ready to Knock Out Your Story?</h2>
