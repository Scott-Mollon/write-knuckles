...
import { SCENE_STATUSES, SCENE_STATUS_COLORS } from '../../constants/taleEditor'
...
const Inspector = ({ scene, taleId, liveWordCount }) => {
  ...
  const [color, setColor] = useState('#938938')
  ...
  useEffect(() => {
    ...
    setColor(scene.scene_color || '#938938')
  }, [scene?.id])
  ...
  return (
    <aside className="w-72 shrink-0 overflow-y-auto border-l border-bronze-dark/50 bg-surface/30 p-4">
      ...
      <div className="space-y-4 text-sm">
        ...
        <div>
          <span className="mb-2 block text-cream/50">Color</span>
