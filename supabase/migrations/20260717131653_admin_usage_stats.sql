-- Admin-only aggregate usage stats for the Admin page.
...
revoke execute on function write.admin_usage_stats() from anon, public;
grant execute on function write.admin_usage_stats() to authenticated;
